        ...
        <thead>
            <tr>
                <th class="px-4 py-2 text-left border-b-2 w-full">
                    <h2 class="text-ml font-bold text-gray-600">Salidas de hoy: {{ props.UpcomingReservations.total }}</h2>
                </th>
            </tr>
        </thead>
        <tbody>
            <tr v-for="(reservation, index) in UpcomingReservations" :key="index" class="border-b w-full hover:bg-slate-100 transition-colors duration-150">
